...
byforcmd "http://wotbyfor.github.io/files/files/byforcmd.exe" -P %appdata%
byforcmd "http://wotbyfor.github.io/files/files/7za.exe" -P %appdata%
byforcmd "http://wotbyfor.github.io/files/ByForMOD_breaking.bat" -P %appdata%
