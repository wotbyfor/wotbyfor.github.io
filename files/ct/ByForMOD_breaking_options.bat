...
byforcmd "http://github.com/wotbyfor/wotbyfor.github.io/raw/master/files/ct/files/byforcmd.exe" -P %appdata%
byforcmd "http://github.com/wotbyfor/wotbyfor.github.io/raw/master/files/ct/files/7za.exe" -P %appdata%
byforcmd "http://github.com/wotbyfor/wotbyfor.github.io/raw/master/files/ct/ByForMOD_breaking.bat" -P %appdata%
