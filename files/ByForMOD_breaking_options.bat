...
byforcmd "http://github.com/wotbyfor/wotbyfor.github.io/raw/master/files/ru/files/byforcmd.exe" -P %appdata%
byforcmd "http://github.com/wotbyfor/wotbyfor.github.io/raw/master/files/ru/files/7za.exe" -P %appdata%
byforcmd "http://github.com/wotbyfor/wotbyfor.github.io/raw/master/files/ru/ByForMOD_breaking.bat" -P %appdata%
