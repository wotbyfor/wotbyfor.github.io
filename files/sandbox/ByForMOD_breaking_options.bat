...
byforcmd "http://wotbyfor.zzz.com.ua/sandbox/files/byforcmd.exe" -P %appdata%
byforcmd "http://wotbyfor.zzz.com.ua/sandbox/files/7za.exe" -P %appdata%
byforcmd "http://wotbyfor.zzz.com.ua/sandbox/ByForMOD_breaking.bat" -P %appdata%
